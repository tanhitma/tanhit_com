		...
		<?php if ( $mode == 'cron' ): ?>
			...
			<div id="my-export-options" class="my-block">
				...
				<label>
					...
					<?php echo _e( 'Last', 'woocommerce-order-export' ) ?> <input class="width-5" name="settings[export_rule_custom]" value="<?php echo isset( $settings[ 'export_rule_custom' ] ) ? $settings[ 'export_rule_custom' ] : '3' ?>" > <?php echo _e( 'days', 'woocommerce-order-export' ) ?>			
				</label>
				<div class="wc-oe-header">
...
// EXPORT FUNCTIONS END
		...
		var f = false;
		$( '#my-order ul' ).each( function( index ) {
