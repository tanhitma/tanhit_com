...
if (!class_exists('MemberLuxAutoSubscriptions')) {
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Templates.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Exports.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Users.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Rejects.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Inbound.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Tags.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Messages.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Whitelists.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Ips.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Internal.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Subaccounts.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Urls.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Webhooks.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Senders.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Metadata.php');
    include_once(WP_PLUGIN_DIR . '/member-luxe/plugins/mandrill/Mandrill/Exceptions.php');
...
function wpm_mandrill_is_on()
{
    $main_options = get_option('wpm_main_options');

    return array_key_exists('mandrill_is_on', $main_options['letters'])
           && $main_options['letters']['mandrill_is_on'] == 'on'
           && !empty($main_options['letters']['mandrill_api_key']);
}
