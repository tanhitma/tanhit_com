            ...
            polylang_info_area: function(){
                ...
                if (form.length)
                {
                    ...
                    var html  = '<span class="caption">&laquo;<b>' + _this.lng[10] + '</b>&raquo; ' + _this.lng[11] + '.</span>';
                        ...
                        html += '<a href="//modeewine.com/en-polylang-theme-strings" target="_blank">' + _this.lng[40] + '</a>';
                        html += '<a href="//modeewine.com/en-donation" target="_blank">' + _this.lng[50] + '</a>';
                        html += '<a href="//wordpress.org/support/view/plugin-reviews/polylang-theme-strings" target="_blank">' + _this.lng[60] + '</a>';
                        html += '</span>';
